...
# TODO: your code here
item = {"name": "Кроссовки", "price": "7540.13", "currency": "rub", "count": "10"}
dollar_rate = 74.12

price = round(float(item["price"]) * int(item["count"])/ dollar_rate, 2)
print(f"цена всех товаров равна {price} долларов")
